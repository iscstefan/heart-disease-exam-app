...
class App extends React.Component {
  ...
  const startItems = [start,start]

    return (
      <div >
        <Menubar model={items} start={startItems} />

        <div className="p-grid">
          <div className='p-col-0 p-md-1'></div>
          <div className='p-col-12 p-md-10'>
            testasdasdasdasdasdasdasdsatestasdasdasdasdasdasdasdsatestasdasdasdasdasdasdasdsatestasdav
            sdasdasdasdasdasdsatestasdasdasdasdasdasdasdsa
            sdasdasdasdasdasdsatestasdasdasdasdasdasdasdsa
            sdasdasdasdasdasdsatestasdasdasdasdasdasdasdsa
            sdasdasdasdasdasdsatestasdasdasdasdasdasdasdsa
            sdasdasdasdasdasdsatestasdasdasdasdasdasdasdsa
